...
function triangle(arg1:number, type1:string, arg2:number, type2:string):string{
    if(arg1 <=0 || arg2 <=0){
    ...
    case "leg":
        ...
        switch(type2){
            case "leg":{
                let b:number = arg2;
                let c:number = Math.sqrt(a**2 + b**2); 
                if(c<=a || c<=b)  {
                ...
                let alpha:number = Math.atan(a/b) * (180/Math.PI);
                let beta:number = Math.atan(b/a) * (180/Math.PI);
                if(alpha <=0 || beta <=0){
            ...
            case "hypotenuse":{
                let c:number = arg2;
                let b:number = Math.sqrt(c**2 - a**2);
                if(c<=a || c<=b)  {
                    console.log("triangle is not triangle bc hypotenuse is smaller than leg or same");
                    return "failed";
                }                
            ...
            case "adjacent angle":{
                let alpha:number = arg2;
                if(alpha>=90){
                    console.log("angle is not sharp(?)");
                    return "failed";
                }
                let c:number = a / Math.cos(alpha * Math.PI / 180);
                let b:number = Math.sqrt(c**2 - a**2);
                if(c<=a || c<=b)  {
                    console.log("triangle is not triangle bc hypotenuse is smaller than leg or same");
                    return "failed";
            ...
            case "opposite angle":{
                let beta:number = arg2;
                if(beta>=90){
                    console.log("angle is not sharp(?)");
                    return "failed";
                }
                let c:number = a / Math.sin(beta * Math.PI / 180);
                let b:number = Math.sqrt(c**2 - a**2);
                if(c<=a || c<=b)  {
                    console.log("triangle is not triangle bc hypotenuse is smaller than leg or same");
                    return "failed";
    ...
    case "hypotenuse":
        ...
        switch(type2){
            ...
            case "angle":{
                ...
                let a:number = c * Math.sin(alpha * Math.PI / 180);
                let b:number = c * Math.sin(beta * Math.PI / 180);
                if(c<=a || c<=b)  {
                    console.log("triangle is not triangle bc hypotenuse is smaller than leg or same");
                    return "failed";
                }                 
